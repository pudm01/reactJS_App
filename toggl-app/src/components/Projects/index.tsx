...
export const Projects = ({ projects }: Props) => {
  ...
  return (
   <>
     ...
     <button className="btn btn-neutral" onClick={() => setEditingProject({id: undefined, name: '', active: true, user_name: process.env.NEXT_PUBLIC_USERNAME!})}>Create new project</button>
